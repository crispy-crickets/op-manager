...
import {
  schema as OrganizerSchema,
  resolvers as OrganizerResolvers,
  queries as OrganizerQueries,
  mutations as OrganizerMutations,
} from './graphql/Organizer/schema';
...
const resolvers = merge(NewsResolvers, OrganizerResolvers, DatabaseResolvers, IntlResolvers);
